...
<div class="msf_content_cell" id="msf-sidebar-container">
    <div id="sidebar">
        <div>
            <span class="msf-h2">Multi Step Form Plus</span>
            <span class="msf-h4">Up to 10 steps</span>
            <p>
                You can now divide your form in up to 10 Steps.
            </p>
            <span class="msf-h4">Save and export Form Data</span>
            <p>
                With PLUS, you can save filled forms in the database and export them as CSV
            </p>
            <span class="msf-h4">Conditional fields</span>
            <p>
