(function($) {
    ...
    function renderCheckbox(block) {
        ...
        textHtml += '<input type="text" class="fw-text-label" placeholder="Label" value="' + block.value + '"></input><br/>';
    ...
    function renderTextArea(block) {
        ...
        textAreaHtml += '<input type="text" class="fw-textarea-label" placeholder="Label" value="' + block.value + '"></input><br/>';
