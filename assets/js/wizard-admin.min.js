(function($) {
    ...
    function renderRadio(radio) {
        ...
        // add button
        radioHtml += '<button class="fw-radio-add button-secondary"><i class="fa fa-plus" aria-hidden="true"></i> Add radio option</button>';
    ...
    function renderCheckbox(block) {
        ...
        textHtml += '<input type="text" class="fw-text-label" placeholder="Label" value="' + block.label + '">';
        textHtml += '</input>';
        return textHtml;
    }
    ...
    function renderTextInput(block) {
        log('textInput', block);
        var textHtml;
        textHtml = '<div class="fw-block-heading fw-block-hndle"><h4>Text field</h4></div>';
    ...
    function renderTextArea(block) {
        ...
        textAreaHtml += '<input type="text" class="fw-textarea-label" placeholder="Label" value="' + block.label + '">';
        textAreaHtml += '</input>';
        return textAreaHtml;
    }
    ...
    function getCheckboxData($text, text) {
    ...
    function stepDrop(event, ui) {
        //        log('stepDrop', event, ui);
        //        // ui.draggable.empty();
        //        var step = renderStep({ title: 'Drop', parts: [] });
        //        log(step);
        //        log(ui.draggable);
        ////        return ui.draggable.helper;
        ////        return step;
        //        // ui.draggable.html(step);
        //        ui.draggable.removeAttr('style');
        ////        ui.draggable.replaceWith(step);
        //        setTimeout(function () {
        //            ui.draggable.removeAttr('style'); // $(container).find('.postbox').removeAttr('style');
        //            setupDragNDrop();
        //        }, 1000);
    }
    ...
    function setupDragNDrop() {
        ...
        $(container + ' .postbox-container').droppable({
            scope: stepScope,
            drop: stepDrop
        });
    ...
    function run() {
        try {
            ...
            $container.on('click', '.fw-radio-add', function() {
                ...
                var idx = $cnt.children('.fw-radio-option').length + 1;
