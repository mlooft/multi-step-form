(function($) {
    ...
    function renderNumeric(block) {
        ...
        numericHtml += '<input type="number" class="fw-numeric-minimum fw-block-label" placeholder="' + wizard.i18n.numeric.no_minimum + '" value="' + block.minimum + '" pattern="-?\d*"></input><br/><br/>';
        numericHtml += '<label>' + wizard.i18n.numeric.maximum + '</label>';
        numericHtml += '<input type="number" class="fw-numeric-maximum fw-block-label" placeholder="' + wizard.i18n.numeric.no_maximum + '" value="' + block.maximum + '" pattern="-?\d*"></input><br/>';
        return numericHtml;
      }
